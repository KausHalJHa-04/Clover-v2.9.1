...
function TopBar({ back, loading }) {
  ...
  const kaushalsides = () => window.open('https://www.kaushalsides.it', '_blank');
  const codeCanyon = () => window.open(
    'https://codecanyon.net/item/kaushal-realtime-messaging-audio-video-conferencing-web-app-nodejs-react-webrtc-socketio/25737452',
    '_blank',
  );
      ...
      <div className="nav">
        ...
        <div className="uk-inline">
          ...
          <div data-uk-dropdown="mode: click; offset: 5; boundary: .top-bar; pos: bottom-right">
            ...
            {Config.demo && (
              <div className="link" onClick={kaushalsides}>
                kaushalsides
                <div className="icon">
                  <FiExternalLink />
                </div>
